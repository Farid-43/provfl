...
def main(args):
    ...
    property_ensemble(vfl_info, 'LR', args, features, aux_prop_index, aux_nonprop_index, prop_npy,file_name)
    property_ensemble(vfl_info, 'SVR', args, features, aux_prop_index, aux_nonprop_index, prop_npy, file_name)
