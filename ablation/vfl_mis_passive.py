...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        if epoch == args.attack_epoch:
            ...
            #     attack_output_a_npy = a_output.cpu().detach().numpy()
            #     attack_prop_npy = target_prop.cpu().detach().numpy()
